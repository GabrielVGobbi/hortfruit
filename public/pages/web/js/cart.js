...
function updatedCart(v) {
  ...
  if (data.length == 0) {
    fetch(base + 'api/products/' + id_product).then(function (r) {
      return r.json();
    }).then(function (data) {
      itens.push({
        productId: data.id,
...
module.exports = __webpack_require__(/*! D:\__Wamp\htdocs\Projetos\Trabalho\HortFruit\HortFruit\resources\js\cart.js */"./resources/js/cart.js");
